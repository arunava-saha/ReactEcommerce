...
const ProductDetails = (props) => {
  ...
  const { isLoading, product, edit, addToCart } = props;
          ...
          >
            ...
            >
              ...
              <FormControl fullWidth variant="standard" sx={{ mb: 3 }}>
                <InputLabel sx={{ fontWeight: 600, fontSize: 20 }}>
                  {" "}
                  Product Title{" "}
                </InputLabel>
                <Input
              ...
              {/* Save button start */}
              <IconButton onClick={() => handleSubmit(productID)} size="large">
        ...
        >
          ...
          >
            ...
            <CardContent sx={{ flex: "1 0 auto", textAlign: "left" }}>
              ...
              {/* product price start */}
              <Typography variant="h4" color="text.tertiary" fontWeight={600}>
                &#8377; &nbsp;
                {Intl
              ...
              {/* product rating start */}
              <Typography component="span" variant="h6" fontSize={25}>
                {/* display stars */}
                <Rating
                  precision={0.1}
