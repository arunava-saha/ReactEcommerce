              ...
              {products.map((item, index) => (
                ...
                >
                  ...
                  >
                    ...
                    {/* product price */}
                    <Typography variant="subtitle1" mb={2} ml={2} noWrap>
                      &#8377;
                      <Typography variant="h6" ml={2} component="span">
                        {/* formatting price */}
                        {Intl.NumberFormat("en-US", {
                          maximumFractionDigits: 2,
                        }).format(item.product.price * 30)}
                      </Typography>
                    </Typography>
...
export default connect(mapStateToProp)(CartPage);
